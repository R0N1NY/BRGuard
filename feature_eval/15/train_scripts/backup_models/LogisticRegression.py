...
train_result_path = os.path.join(script_dir, f'{pt}/train/LogisticRegression_{n}.txt')
...
result_save_path = os.path.join(script_dir, f'{pt}/results/LR_confusion_matrix_{n}.pdf')
...
pred_save_path = os.path.join(script_dir, f'{pt}/val/LogisticRegression_pred_{n}.csv')
...
# Write the DataFrame to CSV
train_save_path = os.path.join(script_dir, f'{pt}/train/LogisticRegression_train_{n}.csv')
