...
train_result_path = os.path.join(script_dir, f'train/NaiveBayes_{n}.txt')
...
result_save_path = os.path.join(script_dir, f'results/NaiveBayes_confusion_matrix_{n}.pdf')
...
pred_save_path = os.path.join(script_dir, f'val/NaiveBayes_pred_{n}.csv')
...
# Write the DataFrame to CSV
train_save_path = os.path.join(script_dir, f'train/NaiveBayes_train_{n}.csv')
