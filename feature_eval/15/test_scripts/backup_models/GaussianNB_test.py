...
result_txt_path = os.path.join(script_dir, 'test', f'GaussianNB_{n}.txt')
...
conf_matrix_path = os.path.join(script_dir, 'results', 'results_test', f'GaussianNB_{n}.pdf')
...
pred_csv_path = os.path.join(script_dir, 'test', f'GaussianNB_test_pred_{n}.csv')
