...
result_txt_path = os.path.join(script_dir, f'{pt}/test', f'LightGBM_{n}.txt')
...
conf_matrix_path = os.path.join(script_dir, f'{pt}/results', 'results_test', f'LightGBM_{n}.pdf')
...
pred_csv_path = os.path.join(script_dir, f'{pt}/test', f'LightGBM_test_pred_{n}.csv')
