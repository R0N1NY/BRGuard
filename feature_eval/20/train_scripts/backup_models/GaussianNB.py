...
model_save_path = os.path.join(script_dir, f'models/GaussianNB_best_model_{n}.pkl')
create_directory_if_not_exists(os.path.dirname(model_save_path))
joblib.dump(best_model, model_save_path)
# joblib.dump(best_model, f'models/GaussianNB_best_model_{n}.pkl')
...
train_result_path = os.path.join(script_dir, f'train/GaussianNB_{n}.txt')
...
result_save_path = os.path.join(script_dir, f'results/GaussianNB_confusion_matrix_{n}.pdf')
...
cm_display.plot()
plt.title('GaussianNB_confusion_matrix')
...
pred_save_path = os.path.join(script_dir, f'val/GaussianNB_pred_{n}.csv')
...
# Write the DataFrame to CSV
train_save_path = os.path.join(script_dir, f'train/GaussianNB_train_{n}.csv')
