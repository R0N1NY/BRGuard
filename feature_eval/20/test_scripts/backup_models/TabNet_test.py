...
model_save_path = os.path.join(script_dir, f'models/TabNet_best_model_{n}.zip')
...
result_txt_path = os.path.join(script_dir, 'test', f'TabNet_{n}.txt')
...
conf_matrix_path = os.path.join(script_dir, 'results', 'results_test', f'TabNet_{n}.pdf')
...
cm_display.plot()
plt.title('TabNet_confusion_matrix')
...
pred_csv_path = os.path.join(script_dir, 'test', f'TabNet_test_pred_{n}.csv')
