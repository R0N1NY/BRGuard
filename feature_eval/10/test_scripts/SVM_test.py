...
result_txt_path = os.path.join(script_dir, f'{pt}/test', f'SVM_{n}.txt')
...
conf_matrix_path = os.path.join(script_dir, f'{pt}/results', 'results_test', f'SVM_{n}.pdf')
...
plt.show()
# plt.savefig('SVM.png', dpi=300, format='png')
...
pred_csv_path = os.path.join(script_dir, f'{pt}/test', f'SVM_test_pred_{n}.csv')
