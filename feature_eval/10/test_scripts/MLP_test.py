...
result_txt_path = os.path.join(script_dir, f'{pt}/test', f'MLP_{n}.txt')
...
conf_matrix_path = os.path.join(script_dir, f'{pt}/results', 'results_test', f'MLP_{n}.pdf')
...
plt.show()
# plt.savefig('MLP.png', dpi=300, format='png')
...
pred_csv_path = os.path.join(script_dir, f'{pt}/test', f'MLP_test_pred_{n}.csv')
