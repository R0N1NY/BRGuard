...
result_txt_path = os.path.join(script_dir, 'test', f'QDA_{n}.txt')
...
conf_matrix_path = os.path.join(script_dir, 'results', 'results_test', f'QDA_{n}.pdf')
...
plt.show()
# plt.savefig('QDA.png', dpi=300, format='png')
...
pred_csv_path = os.path.join(script_dir, 'test', f'QDA_test_pred_{n}.csv')
