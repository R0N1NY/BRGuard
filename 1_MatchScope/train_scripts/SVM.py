...
model_save_path = os.path.join(script_dir, f'{pt}/models/SVM_best_model_{n}.pkl')
...
train_result_path = os.path.join(script_dir, f'{pt}/train/SVM_{n}.txt')
...
result_save_path = os.path.join(script_dir, f'{pt}/results/SVM_confusion_matrix_{n}.pdf')
...
pred_save_path = os.path.join(script_dir, f'{pt}/val/SVM_pred_{n}.csv')
...
# Write the DataFrame to CSV
train_save_path = os.path.join(script_dir, f'{pt}/train/SVM_train_{n}.csv')
