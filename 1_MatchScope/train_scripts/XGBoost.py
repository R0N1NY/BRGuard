...
# Define the parameter grid to search (updated for XGBoost)
param_grid = {
...
model_save_path = os.path.join(script_dir, f'{pt}/models/XGBoost_best_model_{n}.pkl')
...
result_save_path = os.path.join(script_dir, f'{pt}/results/XGBoost_confusion_matrix_{n}.pdf')
...
cm_display.plot()
plt.title('XGBoost_confusion_matrix')
...
pred_save_path = os.path.join(script_dir, f'{pt}/val/XGBoost_pred_{n}.csv')
...
# Write the DataFrame to CSV
train_save_path = os.path.join(script_dir, f'{pt}/train/XGBoost_train_{n}.csv')
