...
model_save_path = os.path.join(script_dir, f'{pt}/models/MLP_best_model_{n}.pkl')
...
train_result_path = os.path.join(script_dir, f'{pt}/train/MLP_{n}.txt')
...
result_save_path = os.path.join(script_dir, f'{pt}/results/MLP_confusion_matrix_{n}.pdf')
...
cm_display.plot()
plt.title('MLP_confusion_matrix')
...
pred_save_path = os.path.join(script_dir, f'{pt}/val/MLP_pred_{n}.csv')
...
# Write the DataFrame to CSV
train_save_path = os.path.join(script_dir, f'{pt}/train/MLP_train_{n}.csv')
